...
const mainHeadData = {
    '/': {
        title: 'Ecommerce',
        desc: "Elevate your online store with Ecommerce. Customizable, SEO-friendly, and user-centric design. Secure payments, intuitive navigation. Unleash your store's potential.",
        canonical: SITE_URL,
        isIndexed: true,
        followLinks: true,
        lastmod: '2024-01-01',
